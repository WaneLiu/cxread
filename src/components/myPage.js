            ...
            <div className="content">
               ...
               <div className="g-container">
                    ...
                    <div className="g-username">
                        ...
                        <img className="img" src="https://b-gold-cdn.xitu.io/v3/static/img/greeting.1415c1c.png" className="g-username"/>
                    </div>
                    <div className="g-password">
                        <input  name="loginPassword" type="password" maxLength="64" placeholder="请输入密码" className="input"/>
                        <img className="img" src="https://b-gold-cdn.xitu.io/v3/static/img/blindfold.58ce423.png" className="g-password"/>
                    </div>
                    <img className="img" src="https://b-gold-cdn.xitu.io/v3/static/img/normal.0447fe9.png" className="g-normal"/>
